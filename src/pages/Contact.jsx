...
const Contact = () => {
    return (
        <div id='contact' className='w-2/3 py-32 -mt-[6rem] overflow-hidden'>
            <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className='bg-[#1d3352] rounded-2xl px-8 py-10'>
                ...
                <form action="">
                    ...
                    <button className='bg-[#0a1130] hover:bg-[#545c81] text-lg font-semibold uppercase rounded-lg transition duration-700 ease-in-out px-6 py-3'>Send <img src={mail} alt="" className='inline w-6 ml-2' /></button>
                </form>
            </motion.div>
        </div>
    );
